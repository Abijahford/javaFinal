...
public class dataStruct extends JFrame implements ActionListener {  
    ...
    private String mode;
    private QuestionCollections questionDataStructCollections;
    private Sub3 questionDataStructPack;
    private int rightAnswer;
    
    dataStruct(String s, String mode){   
        super(s);
        this.mode = mode;
        questionDataStructPack = new Sub3(mode);
        questionDataStructCollections = questionDataStructPack.getCollections();
        l=new JLabel();  
        add(l);  
        bg=new ButtonGroup(); 
    ...
    void set(){ 
        ...
        if (current <= 4) {
        	Question question = questionDataStructCollections.getQuestion();
